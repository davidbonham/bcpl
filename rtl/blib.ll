...
lab_L046.outer:                                   ; preds = %lab_L068, %jt.then_L049
  %if_cond277.ph = phi i1 [ true, %jt.then_L049 ], [ false, %lab_L068 ]
  %STK25.0.ph = phi i64 [ 0, %jt.then_L049 ], [ %sub227, %lab_L068 ]
  %STK24.0.ph = phi i64 [ 0, %jt.then_L049 ], [ %sub, %lab_L068 ]
  %STK22.0.ph = phi i64 [ %getbyte.charword57, %jt.then_L049 ], [ %getbyte.charword248, %lab_L068 ]
  %STK2.1.ph = phi i64 [ %add, %jt.then_L049 ], [ %add235, %lab_L068 ]
  br label %lab_L046

lab_L046:                                         ; preds = %lab_L046.backedge, %lab_L046.outer
  %if_cond277 = phi i1 [ %if_cond277.ph, %lab_L046.outer ], [ false, %lab_L046.backedge ]
  ...
  switch i64 %fnap, label %lab_L052 [
    ...
    i64 78, label %lf_L047.loopexit1488
    i64 88, label %lab_L084
    i64 79, label %lab_L083
    i64 35, label %lf_L047.loopexit1395
...
lab_L065:                                         ; preds = %lab_L065.preheader, %lab_L065
  ...
  %STK22.2 = phi i64 [ %getbyte.charword130, %lab_L065 ], [ %STK22.0, %lab_L065.preheader ]
  %STK2.3 = phi i64 [ %add117, %lab_L065 ], [ %STK2.1, %lab_L065.preheader ]
...
lab_L054:                                         ; preds = %lab_L065
  ...
  br i1 %eq162.not, label %jf.else167, label %lab_L046.backedge

lab_L046.backedge:                                ; preds = %lab_L054, %jf.else167
  %STK22.0.be = phi i64 [ %getbyte.charword130, %lab_L054 ], [ %getbyte.charword186, %jf.else167 ]
  %STK2.1.be = phi i64 [ %add117, %lab_L054 ], [ %add173, %jf.else167 ]
  br label %lab_L046

jf.else167:                                       ; preds = %lab_L054
  ...
  br i1 %or.cond1170, label %lab_L046.backedge, label %lab_L068

lab_L068:                                         ; preds = %jf.else167, %lab_L068
  %STK25.1 = phi i64 [ %sub227, %lab_L068 ], [ %STK25.0.ph, %jf.else167 ]
  %STK22.3 = phi i64 [ %getbyte.charword248, %lab_L068 ], [ %getbyte.charword186, %jf.else167 ]
  %STK2.4 = phi i64 [ %add235, %lab_L068 ], [ %add173, %jf.else167 ]
  ...
  br i1 %or.cond1171, label %lab_L068, label %lab_L046.outer

lab_L072:                                         ; preds = %lab_L046
  br i1 %if_cond277, label %lab_L078.thread, label %jf.else278
...
jf.else278:                                       ; preds = %lab_L072
  %gr = icmp slt i64 %STK25.0.ph, 1
  br i1 %gr, label %jt.then_L075, label %lab_L074

lab_L074:                                         ; preds = %jf.else278, %lab_L074
  %STK280.0 = phi i64 [ %add307, %lab_L074 ], [ 1, %jf.else278 ]
  %STK279.0 = phi i64 [ %mul299, %lab_L074 ], [ 1, %jf.else278 ]
  %mul299 = mul i64 %STK279.0, 10
  %add307 = add i64 %STK280.0, 1
  %le316.not = icmp sgt i64 %add307, %STK25.0.ph
  br i1 %le316.not, label %jt.then_L075, label %lab_L074

jt.then_L075:                                     ; preds = %lab_L074, %jf.else278
  %STK279.1 = phi i64 [ 1, %jf.else278 ], [ %mul299, %lab_L074 ]
...
lab_L117.i:                                       ; preds = %lab_L114.i, %lab_L117.i
  %STK71.0.i = phi i64 [ %add105.i, %lab_L117.i ], [ %add70.i, %lab_L114.i ]
...
jt.then_L118.i:                                   ; preds = %lab_L117.i, %lab_L114.i
  br i1 %if_cond.i, label %jt.else128.i, label %jf.then_L123.i

jt.else128.i:                                     ; preds = %jt.then_L118.i
...
lab_L078:                                         ; preds = %lab_L046
  ...
  br i1 %if_cond277, label %jt.else488, label %jt.then_L089
...
jt.else488:                                       ; preds = %lab_L078.thread, %lab_L078, %lab_L080, %lab_L083, %lab_L084, %lab_L086, %lab_L087, %lf_L048
  %STK23.1.ph1392 = phi i64 [ %lg.value470, %lab_L087 ], [ ptrtoint (ptr @writebin to i64), %lf_L048 ], [ %lg.value463, %lab_L086 ], [ %lg.value449, %lab_L084 ], [ %lg.value442, %lab_L083 ], [ %lg.value421, %lab_L080 ], [ %lg.value407, %lab_L078 ], [ %lg.value4071394, %lab_L078.thread ]
...
jt.then_L089:                                     ; preds = %lab_L078, %lab_L080, %lab_L083, %lab_L084, %lab_L086, %lab_L087, %jt.else488, %lf_L048
  %STK23.1.ph1391 = phi i64 [ ptrtoint (ptr @writebin to i64), %lf_L048 ], [ %STK23.1.ph1392, %jt.else488 ], [ %lg.value470, %lab_L087 ], [ %lg.value463, %lab_L086 ], [ %lg.value449, %lab_L084 ], [ %lg.value442, %lab_L083 ], [ %lg.value421, %lab_L080 ], [ %lg.value407, %lab_L078 ]
  %STK24.3 = phi i64 [ %STK24.0, %lf_L048 ], [ %__res_a.0, %jt.else488 ], [ %STK24.0, %lab_L087 ], [ %STK24.0, %lab_L086 ], [ %STK24.0, %lab_L084 ], [ %STK24.0, %lab_L083 ], [ %STK24.0, %lab_L080 ], [ %STK24.0, %lab_L078 ]
  %STK2.6 = phi i64 [ %STK2.1, %lf_L048 ], [ %add494, %jt.else488 ], [ %STK2.1, %lab_L087 ], [ %STK2.1, %lab_L086 ], [ %STK2.1, %lab_L084 ], [ %STK2.1, %lab_L083 ], [ %STK2.1, %lab_L080 ], [ %STK2.1, %lab_L078 ]
...
lf_L047.loopexit1395:                             ; preds = %lab_L046
  br label %lf_L047

lf_L047.loopexit1488:                             ; preds = %lab_L046
  br label %lf_L047

lf_L047.loopexit:                                 ; preds = %lab_L046
  br label %lf_L047

lf_L047:                                          ; preds = %lab_L046, %lf_L047.loopexit, %lf_L047.loopexit1488, %lf_L047.loopexit1395
  %STK23.1.ph1185.in = phi ptr [ getelementptr inbounds nuw (i8, ptr @__bcpl_global_vector, i64 1008), %lf_L047.loopexit1395 ], [ getelementptr inbounds nuw (i8, ptr @__bcpl_global_vector, i64 688), %lf_L047.loopexit1488 ], [ getelementptr inbounds nuw (i8, ptr @__bcpl_global_vector, i64 712), %lf_L047.loopexit ], [ getelementptr inbounds nuw (i8, ptr @__bcpl_global_vector, i64 328), %lab_L046 ]
...
lab_L098:                                         ; preds = %lab_L046
  ...
  br i1 %if_cond277, label %jf.then_L099, label %jf.else814

jf.else814:                                       ; preds = %lab_L098
...
jump.target_L100:                                 ; preds = %jf.then_L099, %jf.else814
...
lab_L101:                                         ; preds = %lab_L046
  ...
  br i1 %eq909.not, label %jf.else914, label %jf.then_L102

jf.else914:                                       ; preds = %lab_L101
  ...
  br i1 %gr932, label %jump.target_L044, label %lab_L104

lab_L104:                                         ; preds = %jf.else914, %lab_L105
  %getbyte.char10101389 = phi i8 [ %getbyte.char1010, %lab_L105 ], [ %getbyte.char927, %jf.else914 ]
  %STK916.0 = phi i64 [ %STK916.1, %lab_L105 ], [ %booltoword855, %jf.else914 ]
  %STK2.7 = phi i64 [ %add955, %lab_L105 ], [ %add901, %jf.else914 ]
  ...
  br i1 %eq963.not, label %jf.else968, label %jf.then_L107

jf.else968:                                       ; preds = %lab_L104
  %not = xor i64 %STK916.0, -1
  %eq980 = icmp eq i64 %booltoword855, %not
  br i1 %eq980, label %jump.target_L044, label %lab_L105

jf.then_L107:                                     ; preds = %lab_L104
  %if_cond990.not = icmp eq i64 %STK916.0, 0
  br i1 %if_cond990.not, label %jt.else991, label %lab_L105

jt.else991:                                       ; preds = %jf.then_L107
...
lab_L105:                                         ; preds = %jf.else968, %jt.else991, %jf.then_L107
  %getbyte.char1010 = phi i8 [ %getbyte.char10101389, %jf.then_L107 ], [ %getbyte.char1010.pre, %jt.else991 ], [ %getbyte.char10101389, %jf.else968 ]
  %STK916.1 = phi i64 [ -1, %jf.then_L107 ], [ 0, %jt.else991 ], [ %not, %jf.else968 ]
  %getbyte.charword1011 = zext i8 %getbyte.char1010 to i64
  %gr1015.not.not = icmp slt i64 %STK2.7, %getbyte.charword1011
  br i1 %gr1015.not.not, label %lab_L104, label %jump.target_L044

jf.then_L102:                                     ; preds = %lab_L101
  br i1 %ne, label %jf.else1026, label %jump.target_L044

jf.else1026:                                      ; preds = %jf.then_L102
...
jump.target_L044:                                 ; preds = %lab_L105, %jf.else968, %jf.then_L102, %jf.else1026, %jf.else914, %jump.target_L100, %lab_L097, %lab_L095, %lab_L094, %lab_L093, %lf_L047, %jt.then_L089, %writedz.exit, %lab_L052, %jt.else
  %STK2.8 = phi i64 [ %add91, %lab_L052 ], [ %add598, %jt.then_L089 ], [ %add635, %lf_L047 ], [ %add403, %writedz.exit ], [ %add662, %lab_L093 ], [ %add689, %lab_L094 ], [ %add747, %lab_L095 ], [ %add788, %lab_L097 ], [ %add846, %jump.target_L100 ], [ %add901, %jf.then_L102 ], [ %add901, %jf.else1026 ], [ %add901, %jf.else914 ], [ %add, %jt.else ], [ %add955, %jf.else968 ], [ %add955, %lab_L105 ]
  ...
  br i1 %le1053.not, label %jf.then_L045, label %lab_L043
...
lab_L117:                                         ; preds = %lab_L117.preheader, %lab_L117
  %STK71.0 = phi i64 [ %add105, %lab_L117 ], [ %add70, %lab_L117.preheader ]
...
jt.then_L118:                                     ; preds = %lab_L117, %jf.then_L116
  ...
  br i1 %or.cond210, label %jt.else128, label %jf.then_L123

jt.else128:                                       ; preds = %jt.then_L118
...
lab_L134:                                         ; preds = %entry, %lab_L137
  %STK28.0 = phi i64 [ %add, %lab_L137 ], [ 1, %entry ]
  ...
  br i1 %if_cond80, label %lab_L137, label %common.ret

common.ret:                                       ; preds = %lab_L134, %jf.then_L139, %jt.then_L135
  %common.ret.op = phi i64 [ 0, %jt.then_L135 ], [ %.144, %jf.then_L139 ], [ %fnap, %lab_L134 ]
  ret i64 %common.ret.op
...
lab_L145:                                         ; preds = %lab_L145.preheader, %jt.then_L148
  ...
  switch i8 %getbyte.char72, label %jt.else118 [
    i8 47, label %jf.then_L147.loopexit.split.loop.exit201
    i8 61, label %jf.then_L147.loopexit.split.loop.exit201
    i8 44, label %jf.then_L147.loopexit.split.loop.exit201
...
jf.then_L147.loopexit.split.loop.exit201:         ; preds = %lab_L145, %lab_L145, %lab_L145
  %extract.t.le = trunc i64 %STK5.0 to i8
  br label %jf.then_L147

jf.then_L147:                                     ; preds = %jt.then_L143.jf.then_L147_crit_edge, %jf.then_L147.loopexit.split.loop.exit, %jf.then_L147.loopexit.split.loop.exit201
  %putbyte.string173.pre-phi = phi ptr [ %.pre204, %jt.then_L143.jf.then_L147_crit_edge ], [ %putbyte.string, %jf.then_L147.loopexit.split.loop.exit ], [ %putbyte.string, %jf.then_L147.loopexit.split.loop.exit201 ]
  %STK5.2.off0 = phi i8 [ 0, %jt.then_L143.jf.then_L147_crit_edge ], [ %extract.t200.le, %jf.then_L147.loopexit.split.loop.exit ], [ %extract.t.le, %jf.then_L147.loopexit.split.loop.exit201 ]
...
lab_L149.preheader:                               ; preds = %entry
  ...
  br i1 %or.cond, label %lab_L149.preheader182, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %jt.then_L150, label %lab_L149.preheader182

lab_L149.preheader182:                            ; preds = %lab_L149.preheader, %middle.block
  %STK6.0.ph = phi i64 [ 1, %lab_L149.preheader ], [ %4, %middle.block ]
  %STK4.0.ph = phi i64 [ 0, %lab_L149.preheader ], [ %n.vec, %middle.block ]
  br label %lab_L149

lab_L149:                                         ; preds = %lab_L149.preheader182, %lab_L149
  %STK6.0 = phi i64 [ %add42, %lab_L149 ], [ %STK6.0.ph, %lab_L149.preheader182 ]
  %STK4.0 = phi i64 [ %add, %lab_L149 ], [ %STK4.0.ph, %lab_L149.preheader182 ]
...
lab_L153.preheader:                               ; preds = %jt.then_L150
  ...
  br i1 %min.iters.check168, label %lab_L153.preheader181, label %vector.memcheck164

vector.memcheck164:                               ; preds = %lab_L153.preheader
  %9 = add i64 %STK4.1, %stack.vec162
  %10 = sub i64 %9, %getbyte.llvmaddr62
  %diff.check165 = icmp ult i64 %10, 4
  br i1 %diff.check165, label %lab_L153.preheader181, label %vector.ph169
...
middle.block166:                                  ; preds = %vector.body172
  ...
  br i1 %cmp.n178, label %jt.then_L154, label %lab_L153.preheader181

lab_L153.preheader181:                            ; preds = %vector.memcheck164, %lab_L153.preheader, %middle.block166
  %STK56.0.ph = phi i64 [ 1, %lab_L153.preheader ], [ 1, %vector.memcheck164 ], [ %11, %middle.block166 ]
  %STK4.2.ph = phi i64 [ %STK4.1, %lab_L153.preheader ], [ %STK4.1, %vector.memcheck164 ], [ %12, %middle.block166 ]
  br label %lab_L153

lab_L153:                                         ; preds = %lab_L153.preheader181, %lab_L153
  %STK56.0 = phi i64 [ %add116, %lab_L153 ], [ %STK56.0.ph, %lab_L153.preheader181 ]
  %STK4.2 = phi i64 [ %add85, %lab_L153 ], [ %STK4.2.ph, %lab_L153.preheader181 ]
...
jt.then_L154:                                     ; preds = %lab_L153, %middle.block166, %jt.then_L150
  %STK4.3 = phi i64 [ %STK4.1, %jt.then_L150 ], [ %12, %middle.block166 ], [ %add85, %lab_L153 ]
  %stack.vecaddr = ptrtoint ptr %stack.vec to i64
  %stack.bcpladdr = ashr exact i64 %stack.vecaddr, 3
...
lab_L158:                                         ; preds = %lab_L158.preheader, %lab_L161
  %STK29.0 = phi i64 [ %add266, %lab_L161 ], [ 1, %lab_L158.preheader ]
...
jf.else234:                                       ; preds = %lab_L158
  %add240 = add i64 %STK5.0, 1
  %gr247 = icmp slt i64 %add240, 128
  br i1 %gr247, label %lab_L161, label %jf.else252

common.ret:                                       ; preds = %lab_L235, %jt.then_L206, %jf.else252
  %common.ret.op = phi i64 [ 0, %jf.else252 ], [ %STK4.41898, %jt.then_L206 ], [ 0, %lab_L235 ]
  ret i64 %common.ret.op
...
lab_L161:                                         ; preds = %lab_L161.sink.split, %lab_L158, %jf.else234
  %STK5.1 = phi i64 [ %add240, %jf.else234 ], [ %STK5.0, %lab_L158 ], [ %STK5.0, %lab_L161.sink.split ]
...
jt.then_L159:                                     ; preds = %lab_L161
  ...
  br i1 %gr289, label %jt.then_L174, label %lab_L173.preheader

lab_L173.preheader:                               ; preds = %entry, %jt.then_L159
  %STK5.21944 = phi i64 [ %STK5.1, %jt.then_L159 ], [ 0, %entry ]
  br label %lab_L173

lab_L173:                                         ; preds = %lab_L173.preheader, %lab_L176
  %STK280.0 = phi i64 [ %add330, %lab_L176 ], [ 0, %lab_L173.preheader ]
  ...
  br i1 %eq315.not, label %goto.phi.bb, label %lab_L176

lab_L176:                                         ; preds = %lab_L173
  %add330 = add i64 %STK280.0, 1
  %le339.not = icmp sgt i64 %add330, %STK5.21944
  br i1 %le339.not, label %jt.then_L174, label %lab_L173

jt.then_L174:                                     ; preds = %lab_L176, %jt.then_L159
  %gr2891948 = phi i1 [ true, %jt.then_L159 ], [ false, %lab_L176 ]
  %STK5.21945 = phi i64 [ %STK5.1, %jt.then_L159 ], [ %STK5.21944, %lab_L176 ]
  %add351 = add i64 %2, 1
...
lab_L178.outer:                                   ; preds = %lab_L178.outer.backedge, %jt.then_L174
  %STK4.0.ph = phi i64 [ %add356, %jt.then_L174 ], [ %STK4.0.ph.be, %lab_L178.outer.backedge ]
...
lab_L183:                                         ; preds = %lab_L178, %lab_L178, %lab_L178
  br i1 %gr2891948, label %jt.then_L206, label %lab_L184

lab_L184:                                         ; preds = %lab_L183, %jf.then_L187
  %STK405.0 = phi i64 [ %STK405.2, %jf.then_L187 ], [ %STK5.21945, %lab_L183 ]
  %STK403.0 = phi i64 [ %add974, %jf.then_L187 ], [ 0, %lab_L183 ]
  %STK372.0 = phi i64 [ %STK372.2, %jf.then_L187 ], [ %sub371, %lab_L183 ]
  %STK5.3 = phi i64 [ %STK5.5, %jf.then_L187 ], [ %STK5.21945, %lab_L183 ]
  ...
  br i1 %eq452.not, label %jf.else457, label %jf.then_L187

jf.else457:                                       ; preds = %lab_L184
  ...
  br i1 %eq473.not, label %jf.else478, label %jf.then_L187
...
jf.else478:                                       ; preds = %jf.else457
  ...
  br i1 %eq494.not, label %jf.else499, label %jf.then_L187

jf.else499:                                       ; preds = %jf.else478
  br i1 %gr, label %jt.then_L143.i, label %lab_L141.preheader.i

lab_L141.preheader.i:                             ; preds = %jf.else499
...
lab_L141.i:                                       ; preds = %jf.else.i, %lab_L141.preheader.i
  ...
  %STK2.0.i = phi i64 [ %spec.select.i, %jf.else.i ], [ %STK403.0, %lab_L141.preheader.i ]
...
jt.then_L143.i:                                   ; preds = %jf.else.i, %lab_L141.i, %jf.else499
  %STK4.1.i = phi i64 [ 1, %jf.else499 ], [ %STK4.0.i, %lab_L141.i ], [ %add.i, %jf.else.i ]
...
lab_L145.i:                                       ; preds = %jt.then_L148.i, %lab_L145.preheader.i
  ...
  switch i8 %getbyte.char72.i, label %jt.else118.i [
    i8 47, label %jf.then_L147.loopexit.split.loop.exit201.i
    i8 61, label %jf.then_L147.loopexit.split.loop.exit201.i
    i8 44, label %jf.then_L147.loopexit.split.loop.exit201.i
...
jf.then_L147.loopexit.split.loop.exit201.i:       ; preds = %lab_L145.i, %lab_L145.i, %lab_L145.i
  %extract.t.le.i = trunc i64 %STK5.0.i to i8
  br label %getkeylen.exit

getkeylen.exit:                                   ; preds = %jt.then_L143.i, %jf.then_L147.loopexit.split.loop.exit.i, %jf.then_L147.loopexit.split.loop.exit201.i
  %STK5.2.off0.i = phi i8 [ %extract.t200.le.i, %jf.then_L147.loopexit.split.loop.exit.i ], [ %extract.t.le.i, %jf.then_L147.loopexit.split.loop.exit201.i ], [ 0, %jt.then_L143.i ]
  ...
  br i1 %eq545, label %jt.then_L189, label %jt.else550
...
jt.then_L189:                                     ; preds = %jt.else550, %getkeylen.exit
...
lab_L193:                                         ; preds = %jt.then_L189
  ...
  br i1 %if_cond606, label %jf.then_L194, label %jf.else607

jf.else607:                                       ; preds = %lab_L193
  ...
  br i1 %eq636, label %jt.then_L196, label %jt.else641
...
jt.else641:                                       ; preds = %jf.else607
  ...
  br i1 %eq657.not, label %jt.then_L196, label %jf.then_L195

jt.then_L196:                                     ; preds = %jt.else641, %jf.else607
  store i64 -1, ptr %stind.lv620, align 8
  br label %jf.then_L195

jf.then_L195:                                     ; preds = %jt.then_L196, %jt.else641
...
jf.then_L194:                                     ; preds = %lab_L193
  ...
  br i1 %if_cond724, label %lab_L199, label %jf.else725

jf.else725:                                       ; preds = %jf.then_L194
  ...
  br i1 %if_cond750.not, label %goto.phi.bb, label %jt.then_L198

jt.then_L198:                                     ; preds = %jf.else725
...
lf_L188:                                          ; preds = %goto.phi.bb, %lab_L199
  %STK405.1 = phi i64 [ %STK405.4, %goto.phi.bb ], [ %STK405.0, %lab_L199 ]
  %STK403.1 = phi i64 [ %STK403.4, %goto.phi.bb ], [ %STK403.0, %lab_L199 ]
  %STK372.1 = phi i64 [ %STK372.4, %goto.phi.bb ], [ %sub911, %lab_L199 ]
  %STK5.4 = phi i64 [ %STK5.7, %goto.phi.bb ], [ %STK5.3, %lab_L199 ]
  %STK4.2 = phi i64 [ %STK4.5, %goto.phi.bb ], [ %add896, %lab_L199 ]
...
lab_L200:                                         ; preds = %lab_L200, %lf_L188
  ...
  switch i64 %fnap923, label %lab_L200 [
...
jf.then_L187:                                     ; preds = %jf.then_L187.loopexit, %jt.then_L189, %jt.then_L189, %jt.then_L189, %jf.else478, %jf.else457, %lab_L184
  %STK405.2 = phi i64 [ %STK405.0, %lab_L184 ], [ %STK405.0, %jf.else457 ], [ %STK405.0, %jf.else478 ], [ %STK405.0, %jt.then_L189 ], [ %STK405.0, %jt.then_L189 ], [ %STK405.0, %jt.then_L189 ], [ %STK405.1, %jf.then_L187.loopexit ]
  %STK403.2 = phi i64 [ %STK403.0, %lab_L184 ], [ %STK403.0, %jf.else457 ], [ %STK403.0, %jf.else478 ], [ %STK403.0, %jt.then_L189 ], [ %STK403.0, %jt.then_L189 ], [ %STK403.0, %jt.then_L189 ], [ %STK403.1, %jf.then_L187.loopexit ]
  %STK372.2 = phi i64 [ %STK372.0, %lab_L184 ], [ %STK372.0, %jf.else457 ], [ %STK372.0, %jf.else478 ], [ %STK372.0, %jt.then_L189 ], [ %STK372.0, %jt.then_L189 ], [ %STK372.0, %jt.then_L189 ], [ %STK372.1, %jf.then_L187.loopexit ]
  %STK5.5 = phi i64 [ %STK5.3, %lab_L184 ], [ %STK5.3, %jf.else457 ], [ %STK5.3, %jf.else478 ], [ %STK5.3, %jt.then_L189 ], [ %STK5.3, %jt.then_L189 ], [ %STK5.3, %jt.then_L189 ], [ %STK5.4, %jf.then_L187.loopexit ]
  %STK4.3 = phi i64 [ %STK4.1, %lab_L184 ], [ %STK4.1, %jf.else457 ], [ %STK4.1, %jf.else478 ], [ %STK4.1, %jt.then_L189 ], [ %STK4.1, %jt.then_L189 ], [ %STK4.1, %jt.then_L189 ], [ %STK4.2, %jf.then_L187.loopexit ]
  %add974 = add i64 %STK403.2, 1
  %le983.not = icmp sgt i64 %add974, %STK405.2
  br i1 %le983.not, label %jt.then_L185, label %lab_L184

jt.then_L185:                                     ; preds = %jf.then_L187
  %gr998 = icmp slt i64 %STK5.5, 0
  br i1 %gr998, label %jt.then_L206, label %lab_L205

lab_L205:                                         ; preds = %jt.then_L185, %lab_L208
  %STK989.0 = phi i64 [ %add1040, %lab_L208 ], [ 0, %jt.then_L185 ]
  ...
  br i1 %eq1025.not, label %goto.phi.bb, label %lab_L208

lab_L208:                                         ; preds = %lab_L205
  %add1040 = add i64 %STK989.0, 1
  %le1049.not = icmp sgt i64 %add1040, %STK5.5
  br i1 %le1049.not, label %jt.then_L206, label %lab_L205

jt.then_L206:                                     ; preds = %lab_L208, %lab_L183, %jt.then_L185
  %STK4.41898 = phi i64 [ %STK4.3, %jt.then_L185 ], [ %STK4.0.ph, %lab_L183 ], [ %STK4.3, %lab_L208 ]
...
lab_L268.i:                                       ; preds = %lab_L210, %jf.then_L272.i
  ...
  %STK5.0.i1880 = phi i64 [ %STK5.1.i1887, %jf.then_L272.i ], [ 0, %lab_L210 ]
  %STK4.0.i1881 = phi i64 [ %STK4.2.i1886, %jf.then_L272.i ], [ 0, %lab_L210 ]
  ...
  br i1 %eq.not.i1884, label %jf.else.i1889, label %jf.then_L272.i

jf.else.i1889:                                    ; preds = %lab_L268.i
  switch i8 %getbyte.char.i1883, label %jf.then_L273.i [
    i8 61, label %jt.then_L274.i
    i8 47, label %jt.then_L274.i
    i8 44, label %jt.then_L274.i
  ]

jt.then_L274.i:                                   ; preds = %jf.else.i1889, %jf.else.i1889, %jf.else.i1889
...
jf.then_L273.i:                                   ; preds = %jt.then_L274.i, %jf.else.i1889
...
jf.then_L272.i:                                   ; preds = %jf.then_L273.i, %lab_L268.i
  %STK4.1.i1885 = phi i64 [ %STK4.0.i1881, %lab_L268.i ], [ %add.i1890, %jf.then_L273.i ]
  %STK3.1.i = phi i64 [ %STK3.0.i, %lab_L268.i ], [ %spec.select.i1891, %jf.then_L273.i ]
  ...
  br i1 %le.not.i1888, label %jt.then_L269.i, label %lab_L268.i
...
jf.else191.i:                                     ; preds = %lab_L210, %jt.then_L269.i
  %STK4.3241.i = phi i64 [ %STK4.2.i1886, %jt.then_L269.i ], [ 0, %lab_L210 ]
  %STK5.2240.i = phi i64 [ %STK5.1.i1887, %jt.then_L269.i ], [ 0, %lab_L210 ]
...
findarglen.exit:                                  ; preds = %jt.then_L274.i, %jf.else191.i
  %common.ret.op.i = phi i64 [ %STK5.2240.i, %jf.else191.i ], [ %STK5.0.i1880, %jt.then_L274.i ]
  %ge = icmp slt i64 %common.ret.op.i, 0
  br i1 %ge, label %jf.then_L211, label %jf.else1084
...
jf.else1084:                                      ; preds = %findarglen.exit
  ...
  br i1 %if_cond1110, label %jf.then_L213, label %goto.phi.bb.loopexit1977

jf.then_L213:                                     ; preds = %jf.else1084
  %logand1132.mask = and i64 %rv.rv1096, 4
  %if_cond1141 = icmp eq i64 %logand1132.mask, 0
  br i1 %if_cond1141, label %jf.then_L214, label %jf.else1142

jf.else1142:                                      ; preds = %jf.then_L213
...
lab_L178.backedge:                                ; preds = %jf.else1142, %jt.then_L220
  br label %lab_L178
...
jf.then_L214:                                     ; preds = %jf.then_L213
  ...
  br i1 %eq1204.not, label %jf.else1209, label %jf.then_L215

jf.else1209:                                      ; preds = %jf.then_L214
...
jf.then_L215:                                     ; preds = %jf.else1209, %jf.then_L214
  %STK1198.0 = phi i64 [ %fnap1197, %jf.then_L214 ], [ %fnap1220, %jf.else1209 ]
  %STK1198.0.off = add i64 %STK1198.0, -1
  %switch = icmp ult i64 %STK1198.0.off, 2
  br i1 %switch, label %jt.then_L230, label %goto.phi.bb.loopexit1978

jf.then_L211:                                     ; preds = %jf.else191.i, %jt.then_L269.i, %findarglen.exit
  %common.ret.op.i1901 = phi i64 [ %common.ret.op.i, %findarglen.exit ], [ -1, %jt.then_L269.i ], [ -1, %jf.else191.i ]
  ...
  br i1 %eq1259.not, label %jf.else1264, label %jf.then_L217

jf.else1264:                                      ; preds = %jf.then_L211
  ...
  br i1 %eq1280.not, label %jf.else1285, label %jf.then_L217

jf.else1285:                                      ; preds = %jf.else1264
  br i1 %gr, label %jt.then_L220, label %lab_L219

lab_L219:                                         ; preds = %jf.else1285, %lab_L219
  %STK1286.0 = phi i64 [ %add1324, %lab_L219 ], [ 1, %jf.else1285 ]
  ...
  br i1 %le1333.not, label %jt.then_L220, label %lab_L219

jt.then_L220:                                     ; preds = %lab_L219, %jf.else1285
...
jf.then_L217:                                     ; preds = %jf.else1264, %jf.then_L211
...
lab_L223:                                         ; preds = %lab_L178, %jf.then_L217
  %STK359.0 = phi i64 [ %common.ret.op.i1901, %jf.then_L217 ], [ -1, %lab_L178 ]
  br i1 %gr2891948, label %goto.phi.bb.loopexit1978, label %lab_L225

lab_L225:                                         ; preds = %lab_L223, %lab_L228
  %STK1371.0 = phi i64 [ %add1422, %lab_L228 ], [ 0, %lab_L223 ]
  ...
  br i1 %eq1407.not, label %jf.then_L224, label %lab_L228

lab_L228:                                         ; preds = %lab_L225
  %add1422 = add i64 %STK1371.0, 1
  %le1431.not = icmp sgt i64 %add1422, %STK5.21945
  br i1 %le1431.not, label %jf.then_L224, label %lab_L225

jf.then_L224:                                     ; preds = %lab_L225, %lab_L228
  %STK359.1 = phi i64 [ %STK359.0, %lab_L228 ], [ %STK1371.0, %lab_L225 ]
  %ge1442 = icmp sgt i64 %STK359.1, -1
  br i1 %ge1442, label %jf.then_L224.jt.then_L230_crit_edge, label %goto.phi.bb.loopexit1978
...
jt.then_L230:                                     ; preds = %jf.then_L224.jt.then_L230_crit_edge, %jf.then_L215
  %rv.lv1462.pre-phi = phi ptr [ %.pre1941, %jf.then_L224.jt.then_L230_crit_edge ], [ %rv.lv1095, %jf.then_L215 ]
  %STK359.11907 = phi i64 [ %STK359.1, %jf.then_L224.jt.then_L230_crit_edge ], [ %common.ret.op.i, %jf.then_L215 ]
  ...
  br i1 %if_cond1477, label %jf.then_L231, label %goto.phi.bb.loopexit1978

jf.then_L231:                                     ; preds = %jt.then_L230
  %logand1499.mask = and i64 %rv.rv1463, 8
  %if_cond1508 = icmp eq i64 %logand1499.mask, 0
  br i1 %if_cond1508, label %jf.then_L232, label %jf.else1509

jf.else1509:                                      ; preds = %jf.then_L231
  ...
  br i1 %if_cond1520.not, label %goto.phi.bb.loopexit1978, label %jt.then_L233

jt.then_L233:                                     ; preds = %jf.else1509
...
lab_L178.outer.backedge:                          ; preds = %jf.then_L232, %jt.then_L233
  %STK4.0.ph.be = phi i64 [ %add1583, %jt.then_L233 ], [ %add1656, %jf.then_L232 ]
  br label %lab_L178.outer
...
lab_L234:                                         ; preds = %lab_L234, %lf_L157
  ...
  switch i64 %fnap1673, label %lab_L234 [
...
goto.phi.bb.loopexit1977:                         ; preds = %lab_L178, %jf.else1084
  br label %goto.phi.bb

goto.phi.bb.loopexit1978:                         ; preds = %lab_L223, %jf.then_L224, %jt.then_L230, %jf.else1509, %jf.then_L215
  br label %goto.phi.bb

goto.phi.bb:                                      ; preds = %jf.else, %lab_L173, %lab_L205, %goto.phi.bb.loopexit1978, %goto.phi.bb.loopexit1977, %jt.then_L189, %jf.else725, %jt.then_L198, %jf.then_L195
  %STK405.4 = phi i64 [ %STK405.0, %jt.then_L198 ], [ %STK405.0, %jf.then_L195 ], [ %STK405.0, %jf.else725 ], [ %STK405.0, %jt.then_L189 ], [ undef, %goto.phi.bb.loopexit1977 ], [ undef, %goto.phi.bb.loopexit1978 ], [ %STK405.2, %lab_L205 ], [ undef, %lab_L173 ], [ undef, %jf.else ]
  %STK403.4 = phi i64 [ %STK403.0, %jt.then_L198 ], [ %STK403.0, %jf.then_L195 ], [ %STK403.0, %jf.else725 ], [ %STK403.0, %jt.then_L189 ], [ undef, %goto.phi.bb.loopexit1977 ], [ undef, %goto.phi.bb.loopexit1978 ], [ %add974, %lab_L205 ], [ undef, %lab_L173 ], [ undef, %jf.else ]
  %STK372.4 = phi i64 [ %sub821, %jt.then_L198 ], [ %STK372.0, %jf.then_L195 ], [ %STK372.0, %jf.else725 ], [ %STK372.0, %jt.then_L189 ], [ %sub371, %goto.phi.bb.loopexit1977 ], [ %sub371, %goto.phi.bb.loopexit1978 ], [ %STK372.2, %lab_L205 ], [ undef, %lab_L173 ], [ undef, %jf.else ]
  %STK5.7 = phi i64 [ %STK5.3, %jt.then_L198 ], [ %STK5.3, %jf.then_L195 ], [ %STK5.3, %jf.else725 ], [ %STK5.3, %jt.then_L189 ], [ %STK5.21945, %goto.phi.bb.loopexit1977 ], [ %STK5.21945, %goto.phi.bb.loopexit1978 ], [ %STK5.5, %lab_L205 ], [ %STK5.21944, %lab_L173 ], [ %STK5.0, %jf.else ]
  %STK4.5 = phi i64 [ %add813, %jt.then_L198 ], [ %STK4.1, %jf.then_L195 ], [ %STK4.1, %jf.else725 ], [ %STK4.1, %jt.then_L189 ], [ %STK4.0.ph, %goto.phi.bb.loopexit1977 ], [ %STK4.0.ph, %goto.phi.bb.loopexit1978 ], [ %STK4.3, %lab_L205 ], [ 0, %lab_L173 ], [ 0, %jf.else ]
  %goto.phi = phi ptr [ blockaddress(@rdargslen, %lf_L188), %jt.then_L198 ], [ blockaddress(@rdargslen, %lf_L188), %jf.then_L195 ], [ blockaddress(@rdargslen, %lf_L157), %jf.else725 ], [ blockaddress(@rdargslen, %lf_L157), %jt.then_L189 ], [ blockaddress(@rdargslen, %lf_L157), %goto.phi.bb.loopexit1977 ], [ blockaddress(@rdargslen, %lf_L157), %goto.phi.bb.loopexit1978 ], [ blockaddress(@rdargslen, %lf_L157), %lab_L205 ], [ blockaddress(@rdargslen, %lf_L157), %lab_L173 ], [ blockaddress(@rdargslen, %lf_L157), %jf.else ]
...
jf.then_L255:                                     ; preds = %jf.else252, %jf.then_L254
  %STK15.2.off0 = phi i8 [ %extract.t, %jf.then_L254 ], [ %spec.select606, %jf.else252 ]
...
jf.else191.i:                                     ; preds = %entry, %jt.then_L269.i
  %STK4.3241.i = phi i64 [ %STK4.2.i, %jt.then_L269.i ], [ 0, %entry ]
  %STK5.2240.i = phi i64 [ %STK5.1.i, %jt.then_L269.i ], [ 0, %entry ]
...
findarglen.exit:                                  ; preds = %jt.then_L274.i, %jf.else191.i, %jf.then_L279.i
  %common.ret.op.i = phi i64 [ -1, %jf.then_L279.i ], [ %STK5.2240.i, %jf.else191.i ], [ %STK5.0.i, %jt.then_L274.i ]
...
common.ret:                                       ; preds = %jt.then_L274, %jf.else191, %jf.then_L279
  %common.ret.op = phi i64 [ -1, %jf.then_L279 ], [ %STK5.2240, %jf.else191 ], [ %STK5.0, %jt.then_L274 ]
  ret i64 %common.ret.op
...
jf.else191:                                       ; preds = %entry.jf.else191_crit_edge, %jt.then_L269
  %getbyte.string198.pre-phi = phi ptr [ %.pre244, %entry.jf.else191_crit_edge ], [ %getbyte.string66, %jt.then_L269 ]
  %STK4.3241 = phi i64 [ 0, %entry.jf.else191_crit_edge ], [ %STK4.2, %jt.then_L269 ]
  %STK5.2240 = phi i64 [ 0, %entry.jf.else191_crit_edge ], [ %STK5.1, %jt.then_L269 ]
...
lab_L292:                                         ; preds = %jt.else449, %jf.then_L285
  %STK7.2 = phi i64 [ %STK7.1, %jf.then_L285 ], [ %fnap467, %jt.else449 ]
  %STK1.2 = phi i64 [ %STK1.1, %jf.then_L285 ], [ %add436, %jt.else449 ]
  %1 = add i64 %STK7.2, -58
...
jt.then_L299:                                     ; preds = %jump.target_L293
  ...
  br i1 %ge, label %jf.then_L300, label %jf.else416

jf.else416:                                       ; preds = %jt.then_L299
...
jf.then_L300:                                     ; preds = %jf.else416, %jt.then_L299
  %gr.not = icmp ult i64 %STK1.2, %getbyte.charword
  br i1 %gr.not, label %jt.else449, label %jt.then_L301

jt.else449:                                       ; preds = %jf.then_L300
...
lab_L316.preheader:                               ; preds = %entry
  ...
  br i1 %or.cond, label %lab_L316.preheader165, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %jt.then_L317, label %lab_L316.preheader165

lab_L316.preheader165:                            ; preds = %lab_L316.preheader, %middle.block
  %STK13.0.ph = phi i64 [ 0, %lab_L316.preheader ], [ %n.vec, %middle.block ]
  br label %lab_L316

lab_L316:                                         ; preds = %lab_L316.preheader165, %lab_L316
  %STK13.0 = phi i64 [ %add54, %lab_L316 ], [ %STK13.0.ph, %lab_L316.preheader165 ]
...
lab_L320.preheader:                               ; preds = %jt.then_L317
  ...
  br i1 %min.iters.check155, label %lab_L320.preheader164, label %vector.scevcheck151

vector.scevcheck151:                              ; preds = %lab_L320.preheader
  ...
  %25 = or i1 %23, %24
  br i1 %25, label %lab_L320.preheader164, label %vector.ph156
...
middle.block153:                                  ; preds = %vector.body159
  ...
  br i1 %cmp.n162, label %jt.then_L321, label %lab_L320.preheader164

lab_L320.preheader164:                            ; preds = %vector.scevcheck151, %lab_L320.preheader, %middle.block153
  %STK69.0.ph = phi i64 [ %spec.select, %lab_L320.preheader ], [ %spec.select, %vector.scevcheck151 ], [ %26, %middle.block153 ]
  br label %lab_L320

lab_L320:                                         ; preds = %lab_L320.preheader164, %lab_L320
  %STK69.0 = phi i64 [ %add112, %lab_L320 ], [ %STK69.0.ph, %lab_L320.preheader164 ]
...
jt.then_L321:                                     ; preds = %lab_L320, %middle.block153, %jt.then_L317
...
entry:
  ...
  br i1 %or.cond141, label %jt.then_L325, label %jf.then_L326

jf.then_L326:                                     ; preds = %entry, %lab_L331
  %fnap142 = phi i64 [ %fnap, %lab_L331 ], [ %fnap140, %entry ]
...
jt.then_L325:                                     ; preds = %lab_L331, %entry, %lab_L333
  ...
  %STK1.0 = phi i64 [ %fnap33, %lab_L333 ], [ %fnap140, %entry ], [ %fnap, %lab_L331 ]
  %3 = add i64 %STK1.0, -58
  %or.cond133 = icmp ult i64 %3, -10
  br i1 %or.cond133, label %jf.then_L336, label %lab_L334

lab_L334:                                         ; preds = %jt.then_L325, %lab_L334
  %STK1.1 = phi i64 [ %fnap80, %lab_L334 ], [ %STK1.0, %jt.then_L325 ]
  ...
  br i1 %or.cond134, label %lab_L334, label %jf.then_L336
...
lab_L345:                                         ; preds = %lab_L344, %lab_L345
  ...
  br i1 %gr37, label %lab_L345, label %jf.then_L347.thread
...
jf.then_L347:                                     ; preds = %lab_L344
  ...
  br i1 %if_cond50, label %jump.target_L342, label %lab_L348

lab_L348:                                         ; preds = %jf.then_L347, %lab_L348
  %flhs58 = phi double [ %fresult59, %lab_L348 ], [ %float.itof, %jf.then_L347 ]
  ...
  br i1 %ls74.not, label %jump.target_L342.loopexit, label %lab_L348
...
lab_L351:                                         ; preds = %entry
  ...
  br i1 %comparison126, label %jf.then_L357, label %lab_L355.preheader
...
lab_L355:                                         ; preds = %lab_L355.preheader, %lab_L355
  %STK83.0 = phi i64 [ %add148, %lab_L355 ], [ 0, %lab_L355.preheader ]
  %STK82.1 = phi double [ %fresult139, %lab_L355 ], [ %flhs125, %lab_L355.preheader ]
  ...
  br i1 %comparison166, label %jf.then_L357, label %lab_L355

jf.then_L357:                                     ; preds = %lab_L355, %lab_L351
  %flhs178.pre-phi = phi double [ %flhs125, %lab_L351 ], [ %fresult139, %lab_L355 ]
  %STK83.1 = phi i64 [ 0, %lab_L351 ], [ %add148, %lab_L355 ]
  %STK82.2 = phi i64 [ %STK82.0, %lab_L351 ], [ %fdiv140, %lab_L355 ]
  %comparison179 = fcmp ugt double %flhs178.pre-phi, 1.000000e+00
  br i1 %comparison179, label %jf.then_L360, label %lab_L358.preheader

lab_L358.preheader:                               ; preds = %jf.then_L357
  %lstr.bcpladdr203 = ashr exact i64 ptrtoint (ptr @lstr.global.48 to i64), 3
  br label %lab_L358

lab_L358:                                         ; preds = %lab_L358.preheader, %lab_L358
  %STK83.2 = phi i64 [ %sub200, %lab_L358 ], [ %STK83.1, %lab_L358.preheader ]
  %STK82.3 = phi double [ %fresult191, %lab_L358 ], [ %flhs178.pre-phi, %lab_L358.preheader ]
  ...
  br i1 %comparison224, label %jf.then_L360, label %lab_L358

jf.then_L360:                                     ; preds = %lab_L358, %jf.then_L357
  %flhs250.pre-phi = phi double [ %flhs178.pre-phi, %jf.then_L357 ], [ %fresult191, %lab_L358 ]
  %STK83.3 = phi i64 [ %STK83.1, %jf.then_L357 ], [ %sub200, %lab_L358 ]
  %STK82.4 = phi i64 [ %STK82.2, %jf.then_L357 ], [ %fmul192, %lab_L358 ]
...
lab_L380:                                         ; preds = %entry
  %lstr.bcpladdr441 = ashr exact i64 ptrtoint (ptr @lstr.global.49 to i64), 3
...
jump.target_L342:                                 ; preds = %jump.target_L342.loopexit, %jf.then_L347.thread, %entry, %jf.then_L347, %lab_L380, %lab_L379, %lab_L378, %lab_L377, %lab_L376, %lab_L375, %lab_L374, %lab_L373, %lab_L372, %lab_L371, %lab_L370, %lab_L369, %lab_L368, %lab_L365, %lab_L364, %lab_L363, %jf.then_L360
  %STK5.3 = phi i64 [ -4985279381848933680, %lab_L380 ], [ %STK5.1, %jf.then_L347 ], [ %__res_a.1, %jf.then_L360 ], [ %float264, %lab_L363 ], [ %fix270, %lab_L364 ], [ %__res_a.2, %lab_L365 ], [ %fmul313, %lab_L368 ], [ %fdiv326, %lab_L369 ], [ %fadd, %lab_L370 ], [ %fsub, %lab_L371 ], [ %1, %lab_L372 ], [ %fneg363, %lab_L373 ], [ %feq, %lab_L374 ], [ %fne, %lab_L375 ], [ %fgr, %lab_L376 ], [ %fge412, %lab_L377 ], [ %fls, %lab_L378 ], [ %fle437, %lab_L379 ], [ -1, %entry ], [ %STK5.1535, %jf.then_L347.thread ], [ %fdiv.le, %jump.target_L342.loopexit ]
  ret i64 %STK5.3
}
...
jump.target_L384:                                 ; preds = %lab_L388, %lab_L387, %lab_L386, %lab_L385
  %STK6.0 = phi i64 [ -4985279381848933680, %lab_L388 ], [ %fnap, %lab_L385 ], [ %fnap17, %lab_L386 ], [ %fnap39, %lab_L387 ]
  ret i64 %STK6.0
}
