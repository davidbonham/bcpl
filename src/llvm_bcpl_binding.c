...
BCPLWORD  __bcpl_gv426() __attribute__((alias("llvm_shutdown")));
BCPLWORD  __bcpl_gv427() __attribute__((alias("llvm_context_create")));
BCPLWORD  __bcpl_gv428() __attribute__((alias("llvm_get_global_context")));
BCPLWORD  __bcpl_gv429() __attribute__((alias("llvm_context_dispose")));
BCPLWORD  __bcpl_gv430() __attribute__((alias("llvm_module_create_with_name")));
BCPLWORD  __bcpl_gv431() __attribute__((alias("llvm_module_create_with_name_in_context")));
BCPLWORD  __bcpl_gv432() __attribute__((alias("llvm_dispose_module")));
BCPLWORD  __bcpl_gv433() __attribute__((alias("llvm_dump_module")));
BCPLWORD  __bcpl_gv434() __attribute__((alias("llvm_print_module_to_file")));
BCPLWORD  __bcpl_gv435() __attribute__((alias("llvm_add_function")));
BCPLWORD  __bcpl_gv436() __attribute__((alias("llvm_int64_type_in_context")));
BCPLWORD  __bcpl_gv437() __attribute__((alias("llvm_function_type")));
BCPLWORD  __bcpl_gv438() __attribute__((alias("llvm_array_type")));
BCPLWORD  __bcpl_gv439() __attribute__((alias("llvm_pointer_type")));
BCPLWORD  __bcpl_gv440() __attribute__((alias("llvm_void_type_in_context")));
BCPLWORD  __bcpl_gv441() __attribute__((alias("llvm_print_value_to_string")));
BCPLWORD  __bcpl_gv442() __attribute__((alias("llvm_const_ptr_to_int")));
BCPLWORD  __bcpl_gv443() __attribute__((alias("llvm_const_int_to_ptr")));
BCPLWORD  __bcpl_gv444() __attribute__((alias("llvm_const_int")));
BCPLWORD  __bcpl_gv445() __attribute__((alias("llvm_set_linkage")));
BCPLWORD  __bcpl_gv446() __attribute__((alias("llvm_set_section")));
BCPLWORD  __bcpl_gv447() __attribute__((alias("llvm_set_visibility")));
BCPLWORD  __bcpl_gv448() __attribute__((alias("llvm_add_global")));
BCPLWORD  __bcpl_gv449() __attribute__((alias("llvm_set_initializer")));
BCPLWORD  __bcpl_gv450() __attribute__((alias("llvm_set_externally_initialized")));
BCPLWORD  __bcpl_gv451() __attribute__((alias("llvm_delete_function")));
BCPLWORD  __bcpl_gv452() __attribute__((alias("llvm_insert_existing_basic_block_after_insert_block")));
BCPLWORD  __bcpl_gv453() __attribute__((alias("llvm_append_existing_basic_block")));
BCPLWORD  __bcpl_gv454() __attribute__((alias("llvm_create_basic_block_in_context")));
BCPLWORD  __bcpl_gv455() __attribute__((alias("llvm_append_basic_block_in_context")));
BCPLWORD  __bcpl_gv456() __attribute__((alias("llvm_append_basic_block")));
BCPLWORD  __bcpl_gv457() __attribute__((alias("llvm_insert_basic_block_in_context")));
BCPLWORD  __bcpl_gv458() __attribute__((alias("llvm_insert_basic_block")));
BCPLWORD  __bcpl_gv459() __attribute__((alias("llvm_create_builder_in_context")));
BCPLWORD  __bcpl_gv460() __attribute__((alias("llvm_position_builder")));
BCPLWORD  __bcpl_gv461() __attribute__((alias("llvm_position_builder_before")));
BCPLWORD  __bcpl_gv462() __attribute__((alias("llvm_position_builder_at_end")));
BCPLWORD  __bcpl_gv463() __attribute__((alias("llvm_get_insert_block")));
BCPLWORD  __bcpl_gv464() __attribute__((alias("llvm_clear_insertion_position")));
BCPLWORD  __bcpl_gv465() __attribute__((alias("llvm_insert_into_builder")));
BCPLWORD  __bcpl_gv466() __attribute__((alias("llvm_insert_into_builder_with_name")));
BCPLWORD  __bcpl_gv467() __attribute__((alias("llvm_dispose_builder")));
BCPLWORD  __bcpl_gv468() __attribute__((alias("llvm_build_ret_void")));
BCPLWORD  __bcpl_gv469() __attribute__((alias("llvm_build_ret")));
BCPLWORD  __bcpl_gv470() __attribute__((alias("llvm_build_br")));
BCPLWORD  __bcpl_gv471() __attribute__((alias("llvm_build_cond_br")));
BCPLWORD  __bcpl_gv472() __attribute__((alias("llvm_build_switch")));
BCPLWORD  __bcpl_gv473() __attribute__((alias("llvm_build_indirect_br")));
BCPLWORD  __bcpl_gv474() __attribute__((alias("llvm_add_case")));
BCPLWORD  __bcpl_gv475() __attribute__((alias("llvm_add_destination")));
BCPLWORD  __bcpl_gv476() __attribute__((alias("llvm_build_add")));
BCPLWORD  __bcpl_gv477() __attribute__((alias("llvm_build_nswadd")));
BCPLWORD  __bcpl_gv478() __attribute__((alias("llvm_build_nuwadd")));
BCPLWORD  __bcpl_gv479() __attribute__((alias("llvm_build_fadd")));
BCPLWORD  __bcpl_gv480() __attribute__((alias("llvm_build_sub")));
BCPLWORD  __bcpl_gv481() __attribute__((alias("llvm_build_nswsub")));
BCPLWORD  __bcpl_gv482() __attribute__((alias("llvm_build_nuwsub")));
BCPLWORD  __bcpl_gv483() __attribute__((alias("llvm_build_fsub")));
BCPLWORD  __bcpl_gv484() __attribute__((alias("llvm_build_mul")));
BCPLWORD  __bcpl_gv485() __attribute__((alias("llvm_build_nswmul")));
BCPLWORD  __bcpl_gv486() __attribute__((alias("llvm_build_nuwmul")));
BCPLWORD  __bcpl_gv487() __attribute__((alias("llvm_build_fmul")));
BCPLWORD  __bcpl_gv488() __attribute__((alias("llvm_build_udiv")));
BCPLWORD  __bcpl_gv489() __attribute__((alias("llvm_build_exact_udiv")));
BCPLWORD  __bcpl_gv490() __attribute__((alias("llvm_build_sdiv")));
BCPLWORD  __bcpl_gv491() __attribute__((alias("llvm_build_exact_sdiv")));
BCPLWORD  __bcpl_gv492() __attribute__((alias("llvm_build_fdiv")));
BCPLWORD  __bcpl_gv493() __attribute__((alias("llvm_build_urem")));
BCPLWORD  __bcpl_gv494() __attribute__((alias("llvm_build_srem")));
BCPLWORD  __bcpl_gv495() __attribute__((alias("llvm_build_frem")));
BCPLWORD  __bcpl_gv496() __attribute__((alias("llvm_build_shl")));
BCPLWORD  __bcpl_gv497() __attribute__((alias("llvm_build_lshr")));
BCPLWORD  __bcpl_gv498() __attribute__((alias("llvm_build_ashr")));
BCPLWORD  __bcpl_gv499() __attribute__((alias("llvm_build_and")));
BCPLWORD  __bcpl_gv500() __attribute__((alias("llvm_build_or")));
BCPLWORD  __bcpl_gv501() __attribute__((alias("llvm_build_xor")));
BCPLWORD  __bcpl_gv502() __attribute__((alias("llvm_build_bin_op")));
BCPLWORD  __bcpl_gv503() __attribute__((alias("llvm_build_neg")));
BCPLWORD  __bcpl_gv504() __attribute__((alias("llvm_build_nswneg")));
BCPLWORD  __bcpl_gv505() __attribute__((alias("llvm_build_fneg")));
BCPLWORD  __bcpl_gv506() __attribute__((alias("llvm_build_not")));
BCPLWORD  __bcpl_gv507() __attribute__((alias("llvm_build_alloca")));
BCPLWORD  __bcpl_gv508() __attribute__((alias("llvm_build_array_alloca")));
BCPLWORD  __bcpl_gv509() __attribute__((alias("llvm_build_load2")));
BCPLWORD  __bcpl_gv510() __attribute__((alias("llvm_build_store")));
BCPLWORD  __bcpl_gv511() __attribute__((alias("llvm_build_gep2")));
BCPLWORD  __bcpl_gv512() __attribute__((alias("llvm_build_call2")));
BCPLWORD  __bcpl_gv513() __attribute__((alias("llvm_build_ptr_to_int")));
BCPLWORD  __bcpl_gv514() __attribute__((alias("llvm_build_int_to_ptr")));
BCPLWORD  __bcpl_gv515() __attribute__((alias("llvm_verify_module")));
BCPLWORD  __bcpl_gv516() __attribute__((alias("llvm_get_initializer")));
BCPLWORD  __bcpl_gv517() __attribute__((alias("llvm_get_param")));
BCPLWORD  __bcpl_gv518() __attribute__((alias("llvm_build_icmp")));
BCPLWORD  __bcpl_gv519() __attribute__((alias("llvm_int1type_in_context")));
BCPLWORD  __bcpl_gv520() __attribute__((alias("llvm_get_basic_block_name")));
BCPLWORD  __bcpl_gv521() __attribute__((alias("llvm_get_basic_block_parent")));
BCPLWORD  __bcpl_gv522() __attribute__((alias("llvm_get_basic_block_terminator")));
BCPLWORD  __bcpl_gv523() __attribute__((alias("llvm_count_basic_blocks")));
BCPLWORD  __bcpl_gv524() __attribute__((alias("llvm_get_first_basic_block")));
BCPLWORD  __bcpl_gv525() __attribute__((alias("llvm_get_last_basic_block")));
BCPLWORD  __bcpl_gv526() __attribute__((alias("llvm_get_next_basic_block")));
BCPLWORD  __bcpl_gv527() __attribute__((alias("llvm_get_previous_basic_block")));
BCPLWORD  __bcpl_gv528() __attribute__((alias("llvm_get_entry_basic_block")));
BCPLWORD  __bcpl_gv529() __attribute__((alias("llvm_build_int_cast2")));
BCPLWORD  __bcpl_gv530() __attribute__((alias("llvm_verify_function")));
BCPLWORD  __bcpl_gv531() __attribute__((alias("llvm_print_module_to_string")));
BCPLWORD  __bcpl_gv532() __attribute__((alias("llvm_dispose_message")));
BCPLWORD  __bcpl_gv533() __attribute__((alias("llvm_tracing")));
BCPLWORD  __bcpl_gv534() __attribute__((alias("llvm_const_string_in_context")));
BCPLWORD  __bcpl_gv535() __attribute__((alias("llvm_int8type_in_context")));
BCPLWORD  __bcpl_gv536() __attribute__((alias("llvm_build_extract_element")));
BCPLWORD  __bcpl_gv537() __attribute__((alias("llvm_build_zext")));
BCPLWORD  __bcpl_gv538() __attribute__((alias("llvm_build_pointer_cast")));
BCPLWORD  __bcpl_gv539() __attribute__((alias("llvm_build_global_string")));
BCPLWORD  __bcpl_gv540() __attribute__((alias("llvm_build_global_string_ptr")));
BCPLWORD  __bcpl_gv541() __attribute__((alias("llvm_const_array")));
BCPLWORD  __bcpl_gv542() __attribute__((alias("llvm_get_next_instruction")));
BCPLWORD  __bcpl_gv543() __attribute__((alias("llvm_get_first_instruction")));
BCPLWORD  __bcpl_gv544() __attribute__((alias("llvm_is_aterminator_inst")));
BCPLWORD  __bcpl_gv545() __attribute__((alias("llvm_set_alignment")));
BCPLWORD  __bcpl_gv546() __attribute__((alias("llvm_delete_basic_block")));
BCPLWORD  __bcpl_gv547() __attribute__((alias("llvm_build_free")));
BCPLWORD  __bcpl_gv548() __attribute__((alias("llvm_get_last_instruction")));
BCPLWORD  __bcpl_gv549() __attribute__((alias("llvm_instruction_erase_from_parent")));
BCPLWORD  __bcpl_gv550() __attribute__((alias("llvm_get_instruction_parent")));
BCPLWORD  __bcpl_gv551() __attribute__((alias("llvm_get_previous_instruction")));
BCPLWORD  __bcpl_gv552() __attribute__((alias("llvm_int128type_in_context")));
BCPLWORD  __bcpl_gv553() __attribute__((alias("llvm_double_type_in_context")));
BCPLWORD  __bcpl_gv554() __attribute__((alias("llvm_build_fpto_si")));
BCPLWORD  __bcpl_gv555() __attribute__((alias("llvm_build_sito_fp")));
BCPLWORD  __bcpl_gv556() __attribute__((alias("llvm_build_bit_cast")));
BCPLWORD  __bcpl_gv557() __attribute__((alias("llvm_lookup_intrinsic_id")));
BCPLWORD  __bcpl_gv558() __attribute__((alias("llvm_get_intrinsic_declaration")));
BCPLWORD  __bcpl_gv559() __attribute__((alias("llvm_build_fcmp")));
BCPLWORD  __bcpl_gv560() __attribute__((alias("llvm_block_address")));
BCPLWORD  __bcpl_gv561() __attribute__((alias("llvm_type_of")));
BCPLWORD  __bcpl_gv562() __attribute__((alias("llvm_build_phi")));
BCPLWORD  __bcpl_gv563() __attribute__((alias("llvm_add_incoming")));
BCPLWORD  __bcpl_gv564() __attribute__((alias("llvm_count_incoming")));
BCPLWORD  __bcpl_gv565() __attribute__((alias("llvm_run_passes")));
BCPLWORD  __bcpl_gv566() __attribute__((alias("llvm_initialize_all_target_infos")));
BCPLWORD  __bcpl_gv567() __attribute__((alias("llvm_get_default_target_triple")));
BCPLWORD  __bcpl_gv568() __attribute__((alias("llvm_get_target_from_triple")));
BCPLWORD  __bcpl_gv569() __attribute__((alias("llvm_create_target_machine")));
BCPLWORD  __bcpl_gv570() __attribute__((alias("llvm_dispose_target_machine")));
BCPLWORD  __bcpl_gv571() __attribute__((alias("llvm_create_pass_builder_options")));
BCPLWORD  __bcpl_gv572() __attribute__((alias("llvm_get_error_message")));
BCPLWORD  __bcpl_gv573() __attribute__((alias("llvm_dispose_pass_builder_options")));
BCPLWORD  __bcpl_gv574() __attribute__((alias("llvm_get_target_name")));
BCPLWORD  __bcpl_gv575() __attribute__((alias("llvm_set_function_call_conv")));
BCPLWORD  __bcpl_gv576() __attribute__((alias("llvm_add_alias2")));
BCPLWORD  __bcpl_gv577() __attribute__((alias("llvm_print_type_to_string")));
BCPLWORD  __bcpl_gv578() __attribute__((alias("llvm_get_host_cpuname")));
BCPLWORD  __bcpl_gv579() __attribute__((alias("llvm_get_host_cpufeatures")));
BCPLWORD  __bcpl_gv580() __attribute__((alias("llvm_set_target")));
